...
// In this header, you should import all the public headers of your framework using statements like #import <APWebImageMapKit/PublicHeader.h>

// MapKit
#import <APWebImageMapKit/MKAnnotationView+WebCache.h>
