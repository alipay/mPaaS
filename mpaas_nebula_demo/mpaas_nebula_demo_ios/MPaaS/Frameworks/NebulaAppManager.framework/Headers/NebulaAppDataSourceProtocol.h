...
@protocol NebulaAppDataSourceProtocol;
@protocol NebulaAppProtocol;

@protocol NebulaAppResponseProtocol <NSObject>
...
@property (nonatomic, weak) id<NebulaAppDataSourceProtocol> dataSource;   // dataSource
@property (nonatomic, strong) NSDictionary *headers;
@end

@protocol NebulaAppDataSourceProtocol <NSObject>
@property (nonatomic, readonly, strong) id<NebulaAppProtocol> app;
 ...
 *  @return 返回数据源对象
 */
- (instancetype)initWithApp:(id<NebulaAppProtocol>)app;
 ...
 */
- (id<NebulaAppResponseProtocol>)responseWithUrlString:(NSString *)urlString;
