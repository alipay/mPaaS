...
extern NSString * const kH5ExtParam2; // 落于扩展参数2
...
extern NSString * const kH5BizType   ; //明确指明bizType里，使用行为模型埋点
...
+ (void)logWithOptions:(NSDictionary *)options generalFields:(NSDictionary *)generalFields;
